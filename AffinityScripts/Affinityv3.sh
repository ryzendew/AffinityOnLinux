...
print_step "Copying application icon..."
mkdir -p "/home/$USER/.local/share/icons"
if cp "$(dirname "$0")/../icons/Affinity.png" "/home/$USER/.local/share/icons/Affinity.png" 2>/dev/null || \
   cp "$HOME/.config/AffinityOnLinux/icons/Affinity.png" "/home/$USER/.local/share/icons/Affinity.png" 2>/dev/null; then
    print_success "Icon copied to ~/.local/share/icons/Affinity.png"
else
    print_warning "Could not locate icon file (will continue without it)"
fi
...

{
    ...
    echo "Icon=/home/$USER/.local/share/icons/Affinity.png"
    echo "Path=$directory"
