...
# Download files
# Copy icon from icons folder
mkdir -p "/home/$USER/.local/share/icons"
cp "$(dirname "$0")/../icons/Affinity.png" "/home/$USER/.local/share/icons/Affinity.png" 2>/dev/null || cp "$HOME/.config/AffinityOnLinux/icons/Affinity.png" "/home/$USER/.local/share/icons/Affinity.png" 2>/dev/null || true
...
# Start the setup
echo "Download the Affinity Affinity .exe from https://store.serif.com/account/licences/"
...
rm "/home/$USER/.local/share/applications/wine/Programs/Affinity.desktop"

# Create Desktop Entry
echo "[Desktop Entry]" >> ~/.local/share/applications/Affinity.desktop
echo "Name=Affinity Affinity" >> ~/.local/share/applications/Affinity.desktop
echo "Comment=A powerful image editing software." >> ~/.local/share/applications/Affinity.desktop
echo "Icon=/home/$USER/.local/share/icons/Affinity.png" >> ~/.local/share/applications/Affinity.desktop
